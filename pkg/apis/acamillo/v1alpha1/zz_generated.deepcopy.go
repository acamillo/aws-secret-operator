...
func (in *AWSSecretSpec) DeepCopyInto(out *AWSSecretSpec) {
	*out = *in
	out.SecretsManagerRef = in.SecretsManagerRef
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretsManagerRef) DeepCopyInto(out *SecretsManagerRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretsManagerRef.
func (in *SecretsManagerRef) DeepCopy() *SecretsManagerRef {
	if in == nil {
		return nil
	}
	out := new(SecretsManagerRef)
	in.DeepCopyInto(out)
	return out
}
